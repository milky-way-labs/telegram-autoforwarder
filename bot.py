...
class TelegramForwarder:
    ...
    async def forward_messages_to_channel(self, source_chat_id, destination_chat_id, phrase, sniper_chat_id, quote_amount):
        ...
        while True:
            ...
            for message in reversed(messages):
                ...
                if message.text and '**🔥 BURNED LP 🔥**' in message.text and '**Open time:** `in' in message.text:
                    ...
                    print(snipe_message)
                    await self.client_forward_messages.send_message(sniper_chat_id, snipe_message)
                    print("Snipe set")
...
async def main():
    ...
    if choice == "1":
        ...
        phrase = "Open time:"
        await forwarder.forward_messages_to_channel(source_chat_id, destination_chat_id, phrase, sniper_chat_id, quote_amount)
    else:
